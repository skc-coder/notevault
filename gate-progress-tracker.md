...
# 🎯 GATE Master Progress Tracker (CS & DA)

Select any subject below to open its dedicated dashboard containing **GATE 2027 Chapter-wise progress matrices**, **GATE PYQs**, **Weekly Quizzes**, and **Test Series (GO Overflow & GO Classes)**.
...
## 🧮 GATE Engineering Mathematics & Aptitude

| Subject Name | Subject Dashboard Link | Concept MOC Link |
| :--- | :--- | :--- |
| 🧩 **Discrete Mathematics** | [[subject-dashboards/discrete-mathematics\|Discrete Maths Dashboard]] | [[notes/moc dm\|Discrete Maths MOC]] |
| 🔢 **Linear Algebra** | [[subject-dashboards/linear-algebra\|Linear Algebra Dashboard]] | [[notes/moc la\|Linear Algebra MOC]] |
| 📐 **Calculus** | [[subject-dashboards/calculus\|Calculus Dashboard]] | [[notes/moc calculus\|Calculus MOC]] |
| 🎲 **Probability & Statistics** | [[subject-dashboards/probability-and-statistics\|Probability Dashboard]] | [[notes/moc probablity\|Probability MOC]] |
| 💡 **General Aptitude** | [[subject-dashboards/general-aptitude\|General Aptitude Dashboard]] | [[notes/moc aptitude\|Aptitude MOC]] |
...
| Subject Name | Subject Dashboard Link | Concept MOC Link |
| :--- | :--- | :--- |
| 🤖 **Artificial Intelligence & Machine Learning** | [[subject-dashboards/artificial-intelligence-and-ml\|AI & ML Dashboard]] | [[notes/moc python\|Python MOC]] |
