...
##  Causes and Conditions of Thrashing
...
## Mitigation
Using priority or local page replacement algorithms, reducing the degree of multiprogramming, and maintaining working-set models[cite: 8].
