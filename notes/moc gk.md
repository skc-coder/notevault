...
xychart-beta
    ...
    x-axis ["Firsts", "Defense & Space", "Awards", "Symbols"]
    y-axis "Accuracy %" 0 --> 100
    bar [90, 85, 95, 100]
```

```mermaid
%%{init: {'themeVariables': {'pie1': '#2ecc71', 'pie2': '#f39c12', 'pie3': '#e74c3c'}}}%%
pie title Firsts & Symbols Difficulty
    "Firsts in India (Easy)" : 40
    "Defense & Space (Medium)" : 35
    "Awards & Honours (Medium)" : 25
```

```mermaid
pie title Mistake Breakdown
    "Factual Memory Slip" : 50
    "Confused Terms" : 30
    "Careless Reading" : 20
```
