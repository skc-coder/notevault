...
Most commonly used in 2-D [[gate-cs/math/AP-Calculus-BC/pages/Motion]] problems with two functions that describe the $x$ and $y$ position of an object over time using $y=f(t)$ and $x=g(t)$.

Often times problems involving parametric equations also use [[gate-cs/math/AP-Calculus-BC/pages/Function-Related Integrals]]