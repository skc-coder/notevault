...
## Deadlock 
Every philosopher $P_i$ grabs the left fork first, then grabs the right fork. This leads to Circular Wait Deadlock.
...
### Attempt 1: Greedy Philosopher (Breaking Non preemption)
Snatch the fork out of hand!
...
There are other ways to acheive the assymetry. 
- Flipping the order of even and odd philosopher
- Numbering the resources
...
### Attempt 4: Capacity Restriction (Breaking ME, Pigeonhole Constraint)
