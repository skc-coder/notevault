...
| **Row**   | **Words**                                | **Header Fields**                                            |
| --------- | ---------------------------------------- | ------------------------------------------------------------ |
| **Row 0** | **V**ery **H**eavy **T**raffic **T**oday | **VER** $\to$ **HLEN** $\to$ **TOS** $\to$ **Total Length**  |
| **Row 1** | **I** **F**ound **O**ggy                 | **I**dentification $\to$ **F**lags $\to$ Fragment **O**ffset |
| **Row 2** | **T**raveling **P**ast **C**heckpoints   | **T**TL $\to$ **P**rotocol $\to$ Header **C**hecksum         |
| **Row 3** | **S**ource                               | **Source IP**                                                |
| **Row 4** | **D**estination                          | **Destination IP**                                           |
