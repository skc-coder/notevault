...
```mermaid
pie title Chapter Difficulty Distribution
    "Universe (Hard)" : 1
    "Latitudes & Time (Medium)" : 1
    "Geomorphology (Hard)" : 1
    "Plate Tectonics (Hard)" : 1
    "Rocks & Minerals (Medium)" : 1
    "Landforms (Hard)" : 1
    "Atmosphere & Ozone (Medium)" : 1
    "Winds & Cyclones (Hard)" : 1
    "Clouds & Rainfall (Medium)" : 1
    "Koeppen Climate (Hard)" : 1
    "Oceanography (Hard)" : 1
```
